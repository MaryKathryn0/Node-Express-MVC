...
In this assignment, you'll create a burger logger with MySQL, Node, Express, View Functions and homemade ORM Models (yum!). Be sure to follow the MVC design pattern; use Node and MySQL to query and route data in your app, and View functions to generate your HTML.
...
* Inside your `burger` directory, create a folder named `models`.
  ...
  * In `models`, make a `burger.js` file.
    ...
    * Inside `burger.js`, create a Burger class
...
1. Inside your `burger` directory, create a folder named `views`.
   ...
   * Create the `burgers.views.js` file inside `views` directory.

   * Create the `layouts` directory inside `views` directory.

     * Create the `main.view.js` file inside `layouts` directory.
